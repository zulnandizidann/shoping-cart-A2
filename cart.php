...
// Jika produk sudah ada dalam cart maka pembalian akan diupdate 
for ($1-0; $i<count ($cart) ; $i++) { 
...
// jika produk belum ada dalam cart if ($index == = 1) {
$_SESSION ['cart' ] [ ] =[

'id_produk' => $id,
'nama_produk' => $id_produk['nama_produk'],
